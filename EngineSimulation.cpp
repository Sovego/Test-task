 ...
 */
engine_simulation::engine_simulation(const EngineParameters& param, const double temperature_suf):
	param(param),
...
{
	/*if (V <= 75) {
        return 20.0 + (V - 0.0) * (75.0 - 20.0) / (75.0 - 0.0);
    } else if (V <= 150) {
        return 75.0 + (V - 75.0) * (100.0 - 75.0) / (150.0 - 75.0);
    } else if (V <= 200) {
        return 100.0 + (V - 150.0) * (105.0 - 100.0) / (200.0 - 150.0);
    } else if (V <= 250) {
        return 105.0 + (V - 200.0) * (75.0 - 105.0) / (250.0 - 200.0);
    } else {
        return 75.0 + (V - 250.0) * (0.0 - 75.0) / (300.0 - 250.0);
    }*/
